...
class MenuSectionHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        label = UILabel(frame: CGRectMake(15, CGRectGetMaxY(self.bounds)-28,CGRectGetWidth(self.bounds)-30, 22))
        label.font = UIFont.boldSystemFontOfSize(14.0)
        label.backgroundColor = UIColor.clearColor()
        label.textColor = UIColor(red: 203.0/255.0, green: 206.0/255.0, blue: 209.0/255.0, alpha: 1.0)
